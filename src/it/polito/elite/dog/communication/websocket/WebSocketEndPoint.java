...
public class WebSocketEndPoint extends WebSocketServlet
        implements ManagedService, WebSocketConnector
{
    ...
    public WebSocket doWebSocketConnect(HttpServletRequest req, String arg1)
    {
        ...
        this.logger.log(LogService.LOG_DEBUG,
                "New connection from IP: " + req.getRemoteAddr());
        ...
        if (properties != null)
        {
            ...
            catch (Exception e)
            {
                this.logger.log(LogService.LOG_WARNING,
                        "Error in parsing the required WebSocket path...", e);
            }
        }
    ...
    private void registerHttpServlet()
    {
        try
        {
            ...
            this.http.get().registerServlet(this.webSocketPath, this, null,
                    null);
        }
        catch (Exception e)
        {
            ...
            this.logger.log(LogService.LOG_ERROR,
                    "Impossible to register the servlet", e);
        }
    }
    ...
    {
        WebSocketConnectorInfo newRegistration = new WebSocketConnectorInfo(
                webSocketEndpoint, restEndpoint);
    ...
    {
        WebSocketConnectorInfo newRegistration = new WebSocketConnectorInfo(
                webSocketEndpoint.getClass(), restEndpoint, webSocketEndpoint,
                packages);
        this.registeredEndpoints.add(newRegistration);
    ...
    public void sendMessage(String message, String recipient) throws IOException
    {
        if (message != null && !message.isEmpty()
                && this.connectedClients.containsKey(recipient))
        {
            this.connectedClients.get(recipient).getConnection()
                    .sendMessage(message);
        }
    ...
    {
        this.connectedClients.put(instance,
                new ConnectedClientInfo(instance, connection));
    }
